const GAME_DATA = {
  ...
  quotes: {
    ...
    q_corruption:
      "Tham ô là hành động xấu xa nhất của con người. (Hồ Chí Minh Toàn tập)",
    q_waste:
      "Lãng phí tuy không lấy của công bỏ túi riêng, nhưng kết quả tai hại có khi còn hơn tham ô.",
    ...
    warning_decay: ["Đừng để cái xấu tồn tại!", "Kiên quyết đấu tranh!"],
    game_over_excellent: [
      "Xuất sắc! Bạn đã thấm nhuần tư tưởng 'Cần, Kiệm, Liêm, Chính'.",
      "Đạo đức cách mạng vững vàng!",
    ],
    game_over_good: ["Tốt! Hãy tiếp tục rèn luyện đạo đức cách mạng."],
    game_over_poor: [
  ...
  definitions: {
    ...
    mission:
      "Nhiệm vụ: Kiên quyết loại bỏ 'Giặc nội xâm' và bảo vệ các nhân tố mới.",
    briefing: {
    ...
    debrief: {
      ...
      good: {
        ...
        quote:
          "Một dân tộc, một đảng và mỗi con người, ngày hôm qua là vĩ đại, có sức hấp dẫn lớn, không nhất định hôm nay và ngày mai vẫn được mọi người yêu mến và ca ngợi.",
      },
      poor: {
        title: "CẦN CỐ GẮNG",
        icon: "📚",
  ...
  quizQuestions: [
    ...
    {
      id: "q2",
      question: "Bác Hồ dạy đức tính gì là 'nền tảng của đời sống mới'?",
      options: [
        "Trung thực, dũng cảm, khiêm tốn",
        "Cần, Kiệm, Liêm, Chính",
        "Yêu nước, thương dân, đoàn kết",
        "Học tập, lao động, kỷ luật",
      ],
      correctIndex: 1,
    },
    {
      id: "q3",
      question: "Theo tư tưởng Hồ Chí Minh, 'Đoàn kết' là gì?",
      options: [
    ...
    {
      id: "q4",
      question: "Bác Hồ nói: 'Nước ta là nước dân chủ'. Điều đó có nghĩa là?",
      options: [
        "Nhà nước quyết định mọi việc",
        "Bao nhiêu lợi ích đều vì dân, bao nhiêu quyền hạn đều của dân",
        "Chỉ có lãnh đạo mới có quyền",
        "Dân phải nghe theo nhà nước",
      ],
      correctIndex: 1,
    },
    {
      id: "q5",
      question: "Theo Bác Hồ, bệnh quan liêu dẫn đến hậu quả gì?",
      options: [
        "Làm chậm tiến độ công việc",
        "Là nguồn gốc sinh ra tham ô, lãng phí",
        "Gây khó khăn cho nhân dân",
        "Làm giảm uy tín lãnh đạo",
      ],
      correctIndex: 1,
    },
    {
      id: "q6",
      question: "Bác Hồ dạy: 'Lười biếng là...'?",
      options: [
        "Thói quen xấu cần sửa",
        "Kẻ địch to của dân tộc",
    ...
    {
      id: "q7",
      question: "Theo tư tưởng Hồ Chí Minh, 'khoa học' có vai trò gì?",
      options: [
        "Phục vụ cho những người giàu có",
        "Phải từ sản xuất mà ra và trở lại phục vụ sản xuất",
        "Chỉ dành cho các nhà nghiên cứu",
    ...
    {
      id: "q8",
      question: "Bác Hồ nói về tham ô: 'Tham ô là hành động...'?",
      options: [
        "Cần được giáo dục lại",
        "Có thể tha thứ nếu biết hối cải",
        "Xấu xa nhất của con người",
    ...
    {
      id: "q9",
      question: "Theo Bác Hồ, 'Chia rẽ' gây hậu quả gì?",
      options: [
        "Làm mất đoàn kết tạm thời",
        "Là làm yếu mình, là giúp cho giặc",
        "Gây hiểu lầm giữa các bên",
        "Làm chậm tiến độ công việc",
      ],
      correctIndex: 1,
    },
    {
      id: "q10",
      question: "Người cách mạng phải có gì làm nền tảng theo Bác Hồ?",
      options: [
        "Kiến thức sâu rộng",
        "Đạo đức cách mạng",
        "Sức khỏe tốt",
